this.desert_devil_boss_agent <- this.inherit("scripts/ai/tactical/agent", {
	m = {},
	function create()
	{
		this.agent.create();
	...
	function onAddBehaviors()
	{
		...
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_attack_big_reap"));
		this.addBehavior(this.new("scripts/ai/tactical/behaviors/ai_attack_big_strike"));
	}
