this.hellhound <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		Item = null,
		Name = "Arcanine"
	},
	...
	{
		this.m.Items.getAppearance().Body = "hell_body";
		this.getSprite("body").setBrush("hell_body");
		this.getSprite("head").setBrush("hell_head");
		this.setDirty(true);
	}
	...
	function onInit()
	{
		...
		b.RangedSkill = 0;
		b.MeleeDefense = b.MeleeDefense + 20;
		b.RangedDefense = b.RangedDefense + 25;
		b.ActionPoints = b.ActionPoints + 5;
		...
		body.setBrush("hell_body");
		local armor = this.addSprite("armor");
		this.addSprite("head").setBrush("hell_head");
		local closed_eyes = this.addSprite("closed_eyes");
		closed_eyes.setBrush("hell_eyes_closed");
		closed_eyes.Visible = false;
		local injury = this.addSprite("injury");
		injury.Visible = false;
		injury.setBrush("hell_injured");
