this.big_ed_boss <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
		...
		this.m.Ethnicity = 1;
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/big_ed_agent");
	...
	{
		local weap = this.new("scripts/items/big_ed");
		this.m.Items.equip(weap);
		
		this.m.Items.equip(this.new("scripts/items/armor/legendary/emperors_armor_fake"));
		this.m.Items.equip(this.new("scripts/items/ijirok_fake_helmet"));
	}
