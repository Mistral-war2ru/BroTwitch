this.fruto_rogue_boss <- this.inherit("scripts/entity/tactical/human", {
	m = {},
	function create()
	{
	...
	function onInit()
	{
		...
		sprite.setBrush("fruto_head3");
		
	}

	function assignRandomEquipment()
	{
		this.m.Items.equip(this.new("scripts/items/weapons/named/named_dagger"));
		this.m.Items.equip(this.new("scripts/items/offhand_dagger"));
