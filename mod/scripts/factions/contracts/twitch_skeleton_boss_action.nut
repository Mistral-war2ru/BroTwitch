this.twitch_skeleton_boss_action <- this.inherit("scripts/factions/faction_action", {
	m = {},
	function create()
	{
		this.m.ID = "twitch_skeleton_boss_action";
	...
	{
		local contract = this.new("scripts/contracts/contracts/twitch_skeleton_boss_contract");
